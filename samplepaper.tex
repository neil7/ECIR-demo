...
(GMU)~\cite{arevalo2020gated} or cross-modality attention.
...
Conditional Random Field (CRF)~\cite{crf} or transformer layer atop the extracted features. The goal is to utilize 
